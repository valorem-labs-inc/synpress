...
module.exports = (on, config) => {
  ...
  on('task', {
    ...
    // patch exported playwright commands WIP
    getExpectInstance: playwright.getExpectInstance,
    browser: playwright.browser,
    mainWindow: playwright.mainWindow,
    metamaskWindow: playwright.metamaskWindow,
    metamaskNotificationWindow: playwright.metamaskNotificationWindow,
    metamaskPopupWindow: playwright.metamaskPopupWindow,
    activeTabName: playwright.activeTabName,
    setExpectInstance: playwright.setExpectInstance,
    // clear: playwright.clear,
    // waitFor: playwright.waitFor,
    waitAndClick: playwright.waitAndClick,
    waitAndClickByText: playwright.waitAndClickByText,
    waitAndType: playwright.waitAndType,
    waitAndGetValue: playwright.waitAndGetValue,
    waitAndGetInputValue: playwright.waitAndGetInputValue,
    waitAndGetAttributeValue: playwright.waitAndGetAttributeValue,
    waitAndSetValue: playwright.waitAndSetValue,
    waitAndClearWithBackspace: playwright.waitAndClearWithBackspace,
    waitClearAndType: playwright.waitClearAndType,
    waitForText: playwright.waitForText,
    waitToBeHidden: playwright.waitToBeHidden,
    waitUntilStable: playwright.waitUntilStable,
    waitUntilNotificationWindowIsStable:
      playwright.waitUntilNotificationWindowIsStable,
    waitUntilMetamaskWindowIsStable: playwright.waitUntilMetamaskWindowIsStable,
    fixBlankPage: playwright.fixBlankPage,
    fixCriticalError: playwright.fixCriticalError,
    getExtensionsData: playwright.getExtensionsData,
